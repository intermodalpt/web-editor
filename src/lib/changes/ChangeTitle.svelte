<script>
	...
	import SubrouteDeletion from '$lib/changes/titles/SubrouteDeletion.svelte';
...
{:else if 'SubrouteCreation' in change}
	<SubrouteCreation change={change.SubrouteCreation} />
{:else if 'SubrouteUpdate' in change}
